...
class n3CPL(FLRW):
    """FLRW cosmology with a n=3 nCPL dark energy equation of state and curvature.
    ...
    >>> cosmo = n3CPL(H0=70, Om0=0.3, Ode0=0.7, w0=-0.9, wa=0.2)
    ...
    def w(self, z):
        ...
        return self._w0 + self._wa * z**3 / ( (1.0 + z)**3)
    ...
    def de_density_scale(self, z):
        ...
        return zp1 ** (3 * (1 + self._w0 + self._wa)) * \
            np.exp(-0.5 * self._wa * (1 - aa) * (2*aa**2 - 7*aa + 11))
