...
from n7CPL import n7CPL
import scalar_inv_efuncs

class Flatn7CPL(n7CPL):
    """FLRW cosmology with a n=7 nCDM dark energy equation of state and no curvature.
    ...
    def __init__(self, H0, Om0, w0=-1., wa=0., Tcmb0=2.725,
        ...
        n7CPL.__init__(self, H0, Om0, 0.0, w0=w0, wa=wa, Tcmb0=Tcmb0,
        ...
        self._inv_efunc_scalar = scalar_inv_efuncs.fn7cdm_inv_efunc
        self._inv_efunc_scalar_args = (self._Om0, self._Ode0,
