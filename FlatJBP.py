...
class FlatJBP_CDM(JBP):
    """FLRW cosmology with a JBP dark energy equation of state and no
    curvature.
    ...
    >>> cosmo = FlatJBP_CDM(H0=70, Om0=0.3, w0=-0.9, wa=0.2)
    ...
    def __init__(self, H0, Om0, w0=-1., wa=0., Tcmb0=2.725,
        ...
        JBP.__init__(self, H0, Om0, 0.0, w0=w0, wa=wa, Tcmb0=Tcmb0,
        ...
        self._inv_efunc_scalar = scalar_inv_efuncs.fjbpcdm_inv_efunc
        self._inv_efunc_scalar_args = (self._Om0, self._Ode0,
